...
def team_tile(bg,code,value,logo_url,is_preview):
    ...
    right=render.Box(width=15,height=14,child=render.Column(children=[render.Box(width=15,height=6,child=render.Row(children=[render.Text(code,font="tom-thumb",color=fg)],main_align="center",cross_align="center")),render.Box(width=15,height=8,child=render.Row(children=[render.Text(str(value),font=bottom_font,color=fg)],main_align="center",cross_align="center"))],main_align="start",cross_align="stretch"))
