...
def main(config):
    ...
    cycle_delay={"3":3000,"4":4000,"5":5000,"6":6000,"8":8000,"10":10000,"12":12000,"15":15000}.get(s(config.get("all_games_cycle_time"),"8"),8000)
    return render.Root(delay=cycle_delay,show_full_animation=True,child=render.Animation(children=frames))
def get_schema():
