...
TEAM_BG = {
    ...
    "MIN":"#4F2683", "NE":"#002244", "NO":"#A08A58", "NYG":"#0B2265",
...
THROWBACK = {
    ...
    "DAL":{"name":"Throwback","bg":"#002244"}, "DEN":{"name":"Orange Crush","bg":"#FB4F14"},
    "DET":{"name":"Classic Throwback","bg":"#0076B6"}, "GB":{"name":"Classic Throwback","bg":"#203731"},
    "JAX":{"name":"Prowler Throwback","bg":"#006778"}, "MIA":{"name":"Throwback","bg":"#008E97"},
    "MIN":{"name":"Classic Throwback","bg":"#4F2683"}, "NE":{"name":"Pat Patriot","bg":"#C60C30"},
    "NYG":{"name":"Classic Throwback","bg":"#0B2265"}, "NYJ":{"name":"Legacy Throwback","bg":"#125740"},
    "PHI":{"name":"Kelly Green","bg":"#004953"}, "PIT":{"name":"1933 Throwback","bg":"#101820"},
    "SF":{"name":"94 Throwback","bg":"#AA0000"}, "SEA":{"name":"90s Throwback","bg":"#69BE28"},
    "TB":{"name":"Creamsicle","bg":"#FF7900"}, "TEN":{"name":"Oilers Throwback","bg":"#418FDE"},
...
def s(v, d=""):
    return v if v != None and type(v) == "string" else d

def i(v, d=0):
    return v if v != None and type(v) == "int" else d
...
def live_panel(g, config):
    qc = s(config.get("quarter_color"), WHITE)
    tc = s(config.get("clock_color"), WHITE)
...
def get_games(config):
    ...
    tz = s(config.get("timezone"), s(time.tz(), "America/New_York"))
    games = []
    for event in events:
